...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-20 h-screen bg-gray-50/80 backdrop-blur-sm border-r border-gray-200/50 flex flex-col items-center py-5" style={{ width: 'var(--sidebar-width)' }}>
      {/* Logo */}
      <Link href="/dashboard">
